...
# MQTT
MQTT_HOST = 'radioastronomie.sternwarte-radebeul.de'
MQTT_PORT = 43580
MQTT_USER = None
MQTT_PASS = None
MQTT_ROOT = 'STW/RT300/RADIOID'
MQTT_POLLING = 1
...
def onPollMQTT(client, userdata, message):
	...
	msg = msg.split("=")
	if msg[0] == "adc_connection":
		switch = indiclient.getDevice("ADS1x15_ADC").getSwitch("CONNECTION")
		if msg[1] == "0":
	...
	elif msg[0] == "adc_inttime":
		inttime = indiclient.getDevice("ADS1x15_ADC").getNumber("INT_TIME")
...
if __name__ == '__main__':
	...
	mqttclientid = "STW-Radioid" + ClientIdMQTT()
